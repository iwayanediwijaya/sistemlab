...
namespace simlab.GUI
{
    public partial class view_permohonan : Form
    {
        ...
        public string no_perm, tgl_perm, jenis_keg, nama_pem, alamat_pem, jenis_med1, jenis_med2, kode_kom, kode_op, jumlah_semp, satuan, per_bngkus, jenis_smpl_kom, media_pemb, jenis_smpl_opt, id_ngr_asl, id_ngr_tjn, kode_prov_asl, kode_prov_tjn, id_plbhn_asl, id_plbhn_tjn, target_uj1, target_uj2, target_uj3, target_uj4, target_uj5, target_uj6, target_uj7, target_pet, metode_per1, metode_per2, metode_per3, metode_per4, metode_per5, id_pemilik, dokumen_pend = "";
        ...
        private void dtg_view_permohonan_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                jenis_smpl_kom = rows.Cells["jenis_sampel_komoditi"].Value.ToString();
                ...
                target_pet = rows.Cells["target_pest"].Value.ToString();
        ...
        public String ambil_jenis_sampel_komoditi
        {
            get
            {
                return jenis_smpl_kom;
            }
        }
        ...
        private void txt_cari_permohonan_TextChanged(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("SELECT * FROM tblF_permohonan where no_permohonan Like '%"
                ...
                + txt_cari_permohonan.Text + "%' OR alamat_pemohon Like'%"
